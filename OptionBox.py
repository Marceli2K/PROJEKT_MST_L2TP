...
class OptionBox():
    ...
    def __init__(self, x, y, w, h, color, highlight_color, font, option_list, selected=-1):
        self.color = color
    ...
    def draw_menu_on_screen(self, surf):
...
#             run = False
#
#     selected_option = list1.update_menu(event_list)
#     if selected_option >= 0:
#         print(selected_option)
#
#     window.fill((255, 255, 255))
#     list1.draw_menu_on_screen(window)
#     pygame.display.flip()
#
# pygame.quit()
# exit()